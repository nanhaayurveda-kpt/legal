    ...
    <main className="min-h-screen bg-slate-50 pb-10">
      ...
      <form action={createCase} className="space-y-4 px-4 pt-4">
        ...
        <div>
          ...
          <input name="clientName" type="text" required placeholder="नाम डालें" className={inputClass} />
        </div>

        <div>
          <label className="text-sm font-medium text-slate-700">मुवक्किल का फ़ोन</label>
          <input name="clientPhone" type="tel" inputMode="numeric" placeholder="WhatsApp नंबर" className={inputClass} />
        </div>

        {/* केस */}
        <div>
          <label className="text-sm font-medium text-slate-700">केस नंबर *</label>
          <input name="caseNumber" type="text" required placeholder="केस नंबर डालें" className={inputClass} />
        </div>

        <div>
          <label className="text-sm font-medium text-slate-700">कोर्ट</label>
          <input name="courtName" type="text" placeholder="कोर्ट का नाम" className={inputClass} />
        </div>
        ...
        <div>
          ...
          <select name="caseType" defaultValue="" className={inputClass}>
            ...
            <option value="दीवानी">दीवानी</option>
            <option value="फौजदारी">फौजदारी</option>
            <option value="राजस्व">राजस्व</option>
        ...
        <div>
          ...
          <input name="oppositeParty" type="text" placeholder="विपक्षी पक्ष" className={inputClass} />
        </div>
        ...
        <div>
          ...
          <input name="stage" type="text" placeholder="जैसे — बहस, गवाही" className={inputClass} />
        </div>

        <div>
          <label className="text-sm font-medium text-slate-700">टिप्पणी</label>
          <textarea name="notes" rows={3} placeholder="कोई नोट" className={inputClass} />
        </div>
