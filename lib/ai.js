...
const MODEL = "llama-3.3-70b-versatile"; // model बदले तो सिर्फ़ यहीं बदलो
const GROQ_URL = "https://api.groq.com/openai/v1/chat/completions";

// Groq को prompt भेजो, सिर्फ़ text जवाब लौटाओ (OpenAI-जैसा chat completions)
...
// केस लॉ खोजो (Indian Kanoon) + Groq सिर्फ़ उन्हीं नतीजों पर हिंदी सार दे (RAG)
export async function findCaseLaw(query, { doctypes } = {}) {
  ...
  // 2. सिर्फ़ इन्हीं नतीजों से Groq को सार बनाने को कहो — गढ़ना मना
